...
/************************************************************************************************/
public class SimpleKMeanModifiedPlus
/************************************************************************************************/

{
	...
	/************************************************************************************************/
	 ...
	 //This is called after the constructor call 
	    ...
	    public void cluster(int kClusters,  int call, int iterations, int sVersion,IntArrayList allCentroids)    
	    {
	      ...
	      //        System.out.println();
	            ...
	            for(int i=0; i < dataset.size(); i++)           
	            {
	                ...
	                tempCluster =  clusterMap.get(point);
	              	 ...
	              	 if(simVersion==1)
	              		totalError +=   centroids.get(i).distanceWithDefault(point, cliqueAverage, helper);
	              	 else if(simVersion==2)
	              		totalError +=   centroids.get(i).distanceWithoutDefault(point, cliqueAverage, helper);
	              	 else if(simVersion==3)
	              		totalError +=   centroids.get(i).distanceWithDefaultVS(point, cliqueAverage, helper);
	              	 else if(simVersion==4)
	              		totalError +=  centroids.get(i).distanceWithoutDefaultVS(point, cliqueAverage, helper);
	              	 else if(simVersion==5)
	              		totalError +=   centroids.get(i).distanceWithPCC(point, i, helper);   	 
	              	else if(simVersion==6)
	              		totalError +=   centroids.get(i).distanceWithVS(point, i, helper);
	              	 
	                  
	            }
	               if(myCount>0 && myCount%10==0) 
	            	   System.out.println("Count = " + myCount + ", Total Error= " + totalError);
