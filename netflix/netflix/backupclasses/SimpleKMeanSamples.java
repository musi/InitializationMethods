...
/************************************************************************************************/
public class SimpleKMeanSamples
{
 ...
 /************************************************************************************************/
    ...
    public SimpleKMeanSamples(MemHelper helper)    
    {
        this.helper   = helper;
...
/************************************************************************************************/
                                    ...
                                    double cliqueAverage) 		//golbal average in the database    
    {
      ...
      //Initialise the centroids as k random points in the dataset.
        ...
        {    
	     	timer.start();	              
	     	this.centroids = chooseSampleCentroids(dataset, howManyClusters);       
	        timer.stop();   
...
/**********************************************************************************************/
    ...
    private ArrayList<Centroid> chooseSampleCentroids(IntArrayList dataset,	    //no of users in the database 
