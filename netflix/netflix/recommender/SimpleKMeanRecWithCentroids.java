...
import netflix.backupclasses.MyRecTree;
import netflix.backupclasses.SimpleKMean;
import netflix.backupclasses.SimpleKMeanModifiedPlus;
import netflix.backupclasses.SimpleKMeanPlus;
import netflix.backupclasses.SimpleKMeanPlusAndLogPower;
...
/************************************************************************************************/
{
  ...
  //  private RecTree2 						tree;
	...
	private static StandardKMeans kmeans;
	private static SeedSelector seed;
 ...
 */
    public void callKTree(int callNo, int MAX_ITERATIONS)     
    {
    	...
    	else if(KMeansOrKMeansPlus==1)
    	{
    		...
    		seed = KMeansSelection.getMethodByInterface(0, helper);
    		kmeans = KMeansSelection.getMethodByClass(0, helper);
    	...
    	else if(KMeansOrKMeansPlus==2)
    	{
	        ...
	        IntArrayList allCentroid= new IntArrayList();
			simpleKModifiedPlusTree.cluster(kClusters, callNo, MAX_ITERATIONS, simVersion,allCentroid);       
	        timer.stop();
...
//	    }    	
    	...
    	else if(KMeansOrKMeansPlus==4)
    	{
	        ...
	        simpleKPlusAndLogPowerTree.cluster(kClusters, callNo, MAX_ITERATIONS, simVersion,0.05, 30,1, allCentroids);       
	        timer.stop();
...
//    		  String base  = "C:\\Users\\Musi\\workspace\\MusiRecommender\\DataSets\\SML_ML\\Clustering\\Sparsity\\sml_TrainSet80.dat";
    	...
    	*/	  
    	     //SML
	          ...
	          String path  = "C:\\Users\\Sobia\\tempRecommender\\GitHubRecommender\\netflix\\netflix\\DataSets\\SML_ML\\FiveFoldData\\";

	    	   String test  = "C:\\Users\\Sobia\\tempRecommender\\GitHubRecommender\\netflix\\netflix\\DataSets\\SML_ML\\FiveFoldData\\sml_testSetStoredFold1.dat";
	    	   String base  = "C:\\Users\\Sobia\\tempRecommender\\GitHubRecommender\\netflix\\netflix\\DataSets\\SML_ML\\FiveFoldData\\sml_trainSetStoredFold1.dat"; 
