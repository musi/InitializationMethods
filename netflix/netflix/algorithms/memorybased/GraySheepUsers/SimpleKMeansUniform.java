...
/************************************************************************************************/
public class SimpleKMeansUniform
/************************************************************************************************/
	...
	/************************************************************************************************/
	                                    ...
	                                    double cliqueAverage) 		//golbal average in the database    
	    {
	      ...
	      //Initialise the centroids as k random points in the dataset.
	        ...
	        {     
	        	timer.start();	              
	        	this.centroids = chooseUniformCentroids(dataset, howManyClusters);       
		        timer.stop();   
...
/**********************************************************************************************/
    ...
    private ArrayList<Centroid> chooseUniformCentroids(IntArrayList dataset,	//no of users in the database 
