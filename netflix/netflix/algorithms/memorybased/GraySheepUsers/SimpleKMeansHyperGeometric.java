...
/************************************************************************************************/
public class SimpleKMeansHyperGeometric
/************************************************************************************************/
	...
	/************************************************************************************************/
	                                    ...
	                                    double cliqueAverage) 		//golbal average in the database    
	    {
	      ...
	      //Initialise the centroids as k random points in the dataset.
	        ...
	        {     
	        	timer.start();	              
	        	this.centroids = chooseHyperGeoCentroids(dataset, howManyClusters);       
		        timer.stop();   
		        System.out.println("KMeans Hyper Geometric Distribution centroids took " + timer.getTime() + " s to select");    	
		        timer.resetTimer();
...
/**********************************************************************************************/
    ...
    private ArrayList<Centroid> chooseHyperGeoCentroids(IntArrayList dataset,	//no of users in the database 
