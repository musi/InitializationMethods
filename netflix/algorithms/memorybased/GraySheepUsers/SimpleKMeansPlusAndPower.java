...
/************************************************************************************************/
public class SimpleKMeansPlusAndPower
/************************************************************************************************/
	...
	/************************************************************************************************/
	                                    ...
	                                    double cliqueAverage) 		//golbal average in the database    
	    {
	      ...
	      //Initialise the centroids as k random points in the dataset.
	        ...
	        {     
	        	timer.start();	              
	        	this.centroids = choosePlusPowerCentroids(dataset, howManyClusters);       
		        timer.stop();   
...
/**********************************************************************************************/
    ...
    private ArrayList<Centroid> choosePlusPowerCentroids(IntArrayList dataset,	//no of users in the database 
