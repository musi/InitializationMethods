	...
	/************************************************************************************************/
	                                    ...
	                                    double cliqueAverage) 		//golbal average in the database    
	    {
	      ...
	      //Initialise the centroids as k random points in the dataset.
	        ...
	        {     
	        	timer.start();	              
	        	this.centroids = chooseLogCentroids(dataset, howManyClusters);       
		        timer.stop();   
		        System.out.println("KMeans Logarithmic Distribution centroids took " + timer.getTime() + " s to select");    	
		        timer.resetTimer();
...
/**********************************************************************************************/
    ...
    private ArrayList<Centroid> chooseLogCentroids(IntArrayList dataset,	//no of users in the database 
