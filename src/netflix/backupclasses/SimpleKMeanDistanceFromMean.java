...
/************************************************************************************************/
public class SimpleKMeanDistanceFromMean
/************************************************************************************************/
{
 ...
 /************************************************************************************************/
    ...
    public SimpleKMeanDistanceFromMean(MemHelper helper)    
    {
        this.helper   = helper;
...
/************************************************************************************************/
                                    ...
                                    double cliqueAverage) 		//golbal average in the database    
    {
      ...
      //Initialise the centroids as k random points in the dataset.
        ...
        {    
	     	timer.start();	              
	     	this.centroids = chooseDistantCentroids(dataset, howManyClusters);       
	        timer.stop();   
	        System.out.println("KMeans Distance centroids took " + timer.getTime() + " s to select");    	
	        timer.resetTimer();
...
/**********************************************************************************************/
    ...
    private ArrayList<Centroid> chooseDistantCentroids(IntArrayList dataset,	    //no of users in the database 
    										 		...
    										 		)     
    {
      ...
      //////////////////////////////////////////  
        ...
        // print centroids
        /*int totalCentroids = chosenCentroids.size();
        for (int i=0;i<totalCentroids;i++)
        	{
        		int uid = chosenCentroids.get(i);		//The user id which is
